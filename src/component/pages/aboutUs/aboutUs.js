    ...
    return (
        <>
            <div className="aboutBg">
                <div className="abt-title">ABOUT US <span>LOGISTIC HELPS YOU REALISE YOUR BUSINESS GOALS</span></div>
            </div>
            ...
            <div className="wrapper">
                ...
                <div className="abt-cont">
                    ...
                    <p>Management of information is crucial at any step of the freight forwarding process and being able to access the status of their consignment gives customers a sense of relief. It also instills confidence in them because they can remain in control of the transportation of the consignment. The customers don’t have to wait idly for the consignment to arrive but can know when and how the goods will arrive. This transparency attracts customers’ trust towards the company that in turn strives harder every day to maintain and enhance that trust.</p>
                </div>
            </div>
        </>
    )
