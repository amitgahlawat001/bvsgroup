...
import image from '../../../images/doortodoor.jpg'
         ...
         <img className='aboutBg' src={image} />
            <div className='container'>
                <div className='content-area'>
                    ...
                    <h1 className='title' style={{ textAlign: 'start' }} >Door to Door Logistics</h1>
                    <img width='100%' src={line} />
                    <p>The main objective to present “How to Export Guide”, is to help Export Import communityto understand the practical process of starting a Export Import Business.“How to Export Guide” has been especially designed for start ups, small- and medium-sized enterprises that are considering diversification in Exports. </p>
